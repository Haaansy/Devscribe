...
<head>
    ...
    <title>DevScribe - Create Blog</title>
</head>
...
<body class="bg-slate-900">
    ...
    <div class="container mx-auto py-8 px-4">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('dashboard') }}" class="bg-slate-700 text-white px-4 py-2 rounded-lg">Back to Dashboard</a>
        </div>
        ...
        <div class="bg-slate-800 p-6 rounded-lg shadow-lg">
            ...
            <form action="{{ Route('create.blog') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label for="category" class="block text-gray-300 mb-2">Category <span class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative border-2 border-dashed border-slate-600 rounded-lg p-4 hover:border-blue-500 transition-colors">
                        ...
                        <div id="image-preview" class="mt-3 hidden">
                            ...
                            <button type="button" onclick="removeImage()" class="bg-red-500 text-white px-2 py-1 rounded text-sm mt-2">
                                Remove
                            </button>
                        </div>
                    </div>
...
Format your content as you want it to appear on the blog."
                        >{{ old('content') }}</textarea>
                    <p class="text-gray-400 text-sm mt-2">Formatting tip: Line breaks and spacing will be preserved exactly as entered.</p>
                </div>
